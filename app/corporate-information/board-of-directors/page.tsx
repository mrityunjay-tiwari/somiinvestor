        ...
        <>
            <BGGradientOtherSections>
                <div className="mt-20 flex flex-col justify-center items-center pb-16">
                    ...
                    <h2 className="font-semibold text-lg mt-6 mb-2">COMPANY SECRETARY & COMPLIANCE OFFICER</h2>
                    <h3>Mr. Amit Baxi</h3>
                    <h2 className="font-semibold text-lg mt-6 mb-2">CHIEF FINANCIAL OFFICER</h2>

...
import {
  ...
  BriefProfileList3,
  BriefProfileList4,
} from "@/components/corporate-information/board-member-profiles";
      ...
      <BGGradientOtherSections>
        <div className="mt-20 flex flex-col justify-center items-center pb-16">
          <div className="pb-1 mb-16 flex flex-col items-center">
            ...
            <h2>
              <Link href={"/"}>Home</Link> / Brief profile of Board of Directors
            </h2>
          </div>
          <div className="pt-12 w-4/5 text-justify border-l pl-10 pb-10 shadow-left z-20 bg-white">
            ...
            <h2 className="font-semibold text-lg mb-4 mt-12">
              Mr. Om Prakash Bhansali
            </h2>
            <h3>
              <span className="font-semibold">Position:</span> Chairman and
              Managing Director
            </h3>
            <h3>
            ...
            <h3>
              <span className="font-semibold">Experience:</span> Over 46 years
              in the rubber and conveyor belt manufacturing industry{" "}
            </h3>
            <h3>
              <span className="font-semibold">Board Tenure:</span> Since
              Incorporation
            </h3>
            <h3>
              Mr. Om Prakash Bhansali has been at the helm of our organization
              since its inception in 2000, bringing with him an extensive
              background in the rubber and conveyor belt manufacturing industry.
              He holds a Bachelor of Science degree and has accumulated over 46
              years of invaluable experience in this sector. His profound
              understanding of the industry dynamics, coupled with his
              leadership skills, has been instrumental in steering the company
              towards sustained growth and innovation.
            </h3>
            <h3>
              As the Chairman and Managing Director, Mr. Bhansali is responsible
              for the overall management and strategic direction of the company.
              His vision and commitment to excellence have not only shaped the
              company’s operational framework but have also fostered a culture
              of integrity and professionalism throughout the organization.
              Under his leadership, we have successfully navigated various
              market challenges and established ourselves as a reputable player
              in the industry.
            </h3>
            <h3>
              Mr. Bhansali’s directorship and full-time positions in other body
              corporates further reflect his dedication to advancing our
              industry and contributing to its development. His active
              engagement and participation in industry forums and initiatives
              emphasize his commitment to fostering collaboration and innovation
              within the sector.
            </h3>
            <BriefProfileList1 />
            ...
            <h3>
              <span className="font-semibold">Position:</span> Whole-Time
              Director
            </h3>
            <h3>
              <span className="font-semibold">Education:</span> Bachelor of
              Business Management with Specialization in Marketing
            </h3>
            <h3>
              <span className="font-semibold">Experience:</span> Over 22 years
              of extensive experience in the manufacturing and marketing sectors{" "}
            </h3>
            <h3>
              <span className="font-semibold">Board Tenure:</span> Since
              Incorporation
            ...
            <h3>
              <span className="font-semibold">Education:</span> Post Graduate in
              Commerce
            </h3>
            <h3>
              <span className="font-semibold">Experience:</span> Over 21 years
              of Experience in manufacturing and marketing of Conveyor Belts &
              rubber production.{" "}
            </h3>
            <h3>
              <span className="font-semibold">Board Tenure:</span> Since
            ...
            <h3>
              <span className="font-semibold">Position:</span> Non-Executive
              Independent Director
            </h3>
            <h3>
              <span className="font-semibold">Education:</span> Master of
              Commerce (M.Com)
            </h3>
            <h3>
              <span className="font-semibold">Experience:</span> Over 24 years
              of experience in the fields of Computer and Information Technology{" "}
            </h3>
            <h3>
              <span className="font-semibold">Board Tenure:</span> Joined the
            ...
            <h3>
              <span className="font-semibold">Education:</span> Bachelor of
              Engineering (Honours) in Mechanical Engineering
            </h3>
            <h3>
              <span className="font-semibold">Experience:</span> Over 36 years
              of Experience in the field of Manufacturing of Heavy Earth Moving
              Machinery{" "}
            </h3>
            <h3>
              <span className="font-semibold">Board Tenure:</span> Joined the
            ...
            <h3>
              <span className="font-semibold">Education:</span> Master of
              Commerce (M.Com) & Bachelor of Education (B.Ed) in Economics
            </h3>
            <h3>
              <span className="font-semibold">Experience:</span> 26 years in
            ...
            <h3>
              <span className="font-semibold">Education:</span> Graduated in
              Commerce
            </h3>
            <h3>
              <span className="font-semibold">Experience:</span> Over 9 Years of
              Experience in the field of Accountancy & Law{" "}
            </h3>
            <h3>
              <span className="font-semibold">Board Tenure:</span> Joined the
            ...
            <h3>
              <span className="font-semibold">Experience:</span> 12 Years in
              Administration{" "}
            </h3>
            <h3>
              <span className="font-semibold">Board Tenure:</span> Joined the

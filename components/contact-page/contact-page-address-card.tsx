...
export default function CardFlip({
    title = "Address",
    subtitle = "Please visit Us at :",
    description = "Visit us at :",
    features = ["H-2, 463-466, Sangaria Industrial Area, Jodhpur.", "K.No-58, 58/5, 58/6, Village Tanawara, Tehsil Luni, District Jodhpur"],
}: CardFlipProps) {
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-5">
                        <div className="flex items-center justify-between gap-3">
                            ...
                            <div className="relative group/icon">
                                ...
                                />
                                <LocateIcon className="relative z-10 w-4 h-4 text-yellow-500 transition-transform duration-300 group-hover/icon:scale-110 group-hover/icon:-rotate-12" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="flex-1 space-y-6">
                        ...
                        <div className="space-y-2">
                            {features.map((feature, index) => (
                                ...
                                >
                                    <ArrowRight width={24} className=" text-yellow-500" />
                                    <span>{feature}</span>
                                </div>
                            ))}
                        </div>

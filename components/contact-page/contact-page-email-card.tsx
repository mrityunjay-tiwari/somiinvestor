...
export default function CardFlipEmailId({
    title = "Email Address",
    subtitle = "Mail Us at :",
    description = "Following official email ids :",
    features = ["cmd@somiconveyor.com", "info@ombhansali.com", "csamitbaxi@gmail.com"],
}: CardFlipProps) {
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-5">
                        <div className="flex items-center justify-between gap-3">
                            ...
                            <div className="relative group/icon">
                                ...
                                />
                                <Mail className="relative z-10 w-4 h-4 text-yellow-500 transition-transform duration-300 group-hover/icon:scale-110 group-hover/icon:-rotate-12" />
                            </div>
                        </div>
                    </div>
                </div>

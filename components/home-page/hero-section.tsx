                    ...
                    <div className="relative pt-24 md:pt-36">
                        ...
                        <div
                          ...
                          >
                            <div className="relative flex bg-transparent overflow-hidden">
                              ...
                              <InfiniteSlider speedOnHover={20} speed={40} gap={20} className="w-full bg-transparent rounded-2xl">
                      ...
                      <div className="flex items-center gap-0.5 text-foreground text-sm">
                        An ISO 9001 Company{" "}
                                  ...
                                  <div className='mt-7'>
                                        <Button size={'lg'} className='rounded-full text-white bg-linear-to-r from-slate-900 to-yellow-400 hover:from-yellow-400 hover:to-slate-900 transform transition duration-700 ease-in-out font-medium'> Get in Touch  <ArrowRight className='animate-pulse' /></Button>
                                    </div>
                                  {/* <AnimatedGroup
                                      variants={{
                                          container: {
